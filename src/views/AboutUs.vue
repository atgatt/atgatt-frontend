<template>
  <div class="jumbotron">
    ...
    <p class="lead">
      By the way, we've got big things planned. Sign up to be the first to know about our latest features:
      <br/><br/>
      <email-signup />
    </p>
    <hr />
    ...
    <div class="card">
      <div class="card-header" role="tab" id="terms-of-service-card">
        <h5 class="mb-0">
          <a class="collapsed" data-toggle="collapse" href="#collapse-terms-of-service" role="button" aria-expanded="false" aria-controls="collapse-terms-of-service">
            Terms of Service
          </a>
        </h5>
      </div>
      <div id="collapse-terms-of-service" class="collapse" role="tabpanel" aria-labelledby="terms-of-service-card" data-parent="#accordion">
        <div class="card-body">
              <h5>
                Welcome to ATGATT! We (ATGATT LLC) provide the website located at https://atgatt.co (the “Site”) and the services accessible via our Site and our mobile device application (“App”). To make these Terms easier to read, the Site, our services and App are collectively called the “Services.” Please read these Terms of Service (the “Terms”) carefully because they govern your use of our Services.
              </h5>
              <br />
              ...
              <p>Unless you opt out of arbitration within 30 days of the date you first agree to these terms by following the opt-out procedure specified in the “Arbitration” section below, and except for certain types of disputes described in the “Arbitration“ section below, you agree that disputes between you and ATGATT will be resolved by binding, individual arbitration and you are waiving your right to a trial by jury or to participate as a plaintiff or class member in any purported class action or representative proceeding.
              Who May Use the Services</p>
              <h2>Eligibility</h2>
              <p>You may use the Services only if you are 13 years or older and are not barred from using the Services under applicable law. To make a purchase via the Services (described in the Section titled “Purchases” below), you must be 18 years or older and capable of forming a binding contract.</p>
              ...
              <p>
                ...
                Using the Services
                ATGATT publishes information on this website as a convenience to its users. It is possible and likely that the product specifications, details, appearance, pricing and performance of products described on ATGATT will differ from the same product offered for sale by the manufacturer, distributor or retailer. This often happens for a variety of reasons and we can take no responsibility for those differences. Make sure you contact the manufacturer or retailer for the latest up-to-date pricing, information, specifications and performance information prior to purchasing any of the products described on ATGATT.

                The information presented on ATGATT, including product reviews, comments and evaluations, is based on third-party reviews and is provided for informational purposes only. ATGATT has not individually evaluated any claim or statement regarding the products featured on this site.

                ATGATT attempts to provide accurate and timely information, but there may be inadvertent technical or factual inaccuracies and typographical errors. We reserve the right to make corrections and changes to this website at any time without notice.
                ATGATT cannot guarantee that the product information, photographs, drawings or images accurately portray the actual products as described.

                Your experience with the products or information may, and probably will, be completely different from the information or descriptions on this website, due to many factors, including changes that the manufacturer may make in products over time. The website contains links to websites on the Internet which are owned and operated by third parties. You acknowledge that ATGATT is not responsible for the availability of, or the content located on or through, any external website. You should contact the site administrator or webmaster for those external websites if you have any concerns regarding such links or the content located on such external websites. You assume all responsibility and risk with respect to their use of the website and the information contained herein.
                All information contained on this website is provided to you “AS IS” and ATGATT disclaims all warranties, representations and endorsements, express or implied, with regard to information accessed from or via this website, including but not limited to all express and implied warranties. ATGATT disclaims any duty to update the website or modify the Content or code and shall not be liable for the failure to update the information. ATGATT does not warrant that this website is free of computer viruses or other harmful components and does not warrant that the functionality of this website will be uninterrupted or error-free. ATGATT reserves the right to withdraw access to this website or to revise the Services and products described on the website at any time without notice.
                ...
                ATGATT is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com. Amazon and the Amazon logo are trademarks of Amazon.com, Inc. or its affiliates.
              ...
              <p>
              ATGATT does not claim any ownership rights in any User Content and nothing in these Terms will be deemed to restrict any rights that you may have to use and exploit your User Content. Subject to the foregoing, ATGATT and its licensors exclusively own all right, title and interest in and to the Services and Content, including all associated intellectual property rights. You acknowledge that the Services and Content are protected by copyright, trademark, and other laws of the United States and foreign countries. You agree not to remove, alter or obscure any copyright, trademark, service mark or other proprietary rights notices incorporated in or accompanying the Services or Content.
              </p>
              <h2>
              Rights in User Content Granted by You
              </h2>
              <p>
              By making any User Content available through Services you hereby grant to ATGATT a non-exclusive, transferable, sublicenseable, worldwide, royalty-free license to use, copy, modify, create derivative works based upon, distribute, publicly display, publicly perform and distribute your User Content in connection with operating and providing the Services and Content to you and to other users.
              </p>
              <h2>
              Rights in Content Granted by ATGATT
              </h2>
              <p>
              Subject to your compliance with these Terms, ATGATT grants you a limited, non-exclusive, non-transferable, non-sublicenseable license to download, view, copy and display the Content solely in connection with your permitted use of the Services and solely for your personal and non-commercial purposes.
              </p>
              <h2>
              ...
              <br />
              <h3>
              Rights in App Granted by ATGATT
              </h3>
              <p>
                Subject to your compliance with these Terms, ATGATT grants you a limited non-exclusive, non-transferable, non-sublicenseable license to download and install a copy of the App on a mobile device or computer that you own or control and to run such copy of the App solely for your own personal non-commercial purposes. ATGATT reserves all rights in and to the App not expressly granted to you under these Terms.
                ...
                <ul>
                  ...
                  <li>Use, display, mirror or frame the Services, or any individual element within the Services, ATGATT’s name, any ATGATT trademark, logo or other proprietary information, or the layout and design of any page or form contained on a page, without ATGATT’s express written consent;</li>
                  <li>Access, tamper with, or use non-public areas of the Services, ATGATT’s computer systems, or the technical delivery systems of ATGATT’s providers;</li>
                  <li>Attempt to probe, scan, or test the vulnerability of any ATGATT system or network or breach any security or authentication measures;</li>
                  <li>Avoid, bypass, remove, deactivate, impair, descramble or otherwise circumvent any technological measure implemented by ATGATT or any of ATGATT’s providers or any other third party (including another user) to protect the Services;</li>
                  <li>Attempt to access or search the Services or download Collective Content from the Services through the use of any engine, software, tool, agent, device or mechanism (including spiders, robots, crawlers, data mining tools or the like) other than the software and/or search agents provided by ATGATT or other generally available third party web browsers;</li>
                  ...
                  <li>Use any meta tags or other hidden text or metadata utilizing a ATGATT trademark, logo URL or product name without ATGATT’s express written consent;</li>
              ...
              <p>
              You will indemnify and hold harmless ATGATT and its officers, directors, employee and agents, from and against any claims, disputes, demands, liabilities, damages, losses, and costs and expenses, including, without limitation, reasonable legal and accounting fees, arising out of or in any way connected with (i) your access to or use of the Services or Content or (ii) your violation of these Terms.
              </p>
              <h2>
              Limitation of Liability
              </h2>
              <p>
              Neither ATGATT nor any other party involved in creating, producing, or delivering the Services or Content will be liable for any incidental, special, exemplary or consequential damages, including lost profits, loss of data or goodwill, service interruption, computer damage or system failure or the cost of substitute services arising out of or in connection with these terms or from the use of or inability to use the Services or Content, whether based on warranty, contract, tort (including negligence), product liability or any other legal theory, and whether or not ATGATT has been informed of the possibility of such damage, even if a limited remedy set forth herein is found to have failed of its essential purpose. Some jurisdictions do not allow the exclusion or limitation of liability for consequential or incidental damages, so the above limitation may not apply to you.
              In no event will ATGATT’s total liability arising out of or in connection with these terms or from the use of or inability to use the Services or Content exceed the amounts you have paid to ATGATT for use of the Services or Content or fifty dollars ($50), if you have not had any payment obligations to ATGATT, as applicable. The exclusion and limitations of damages set forth above are fundamental elements of the basis of the bargain between ATGATT and you.
              </p>
              <h2>
              ...
              <p>
              You and ATGATT agree that any dispute, claim or controversy arising out of or relating to these Terms or the breach, termination, enforcement, interpretation or validity thereof or the use of the Services or Content (collectively, “Disputes”) will be settled by binding arbitration, except that each party retains the right: (i) to bring an individual action in small claims court and (ii) to seek injunctive or other equitable relief in a court of competent jurisdiction to prevent the actual or threatened infringement, misappropriation or violation of a party’s copyrights, trademarks, trade secrets, patents or other intellectual property rights (the action described in the foregoing clause (ii), an “IP Protection Action”). Without limiting the preceding sentence, you will also have the right to litigate any other Dispute if you provide ATGATT with written notice of your desire to do so by email at hello@atgatt.co within thirty (30) days following the date you first agree to these Terms (such notice, an “Arbitration Opt-out Notice”). If you don’t provide ATGATT with an Arbitration Opt-out Notice within the thirty (30) day period, you will be deemed to have knowingly and intentionally waived your right to litigate any Dispute except as expressly set forth in clauses (i) and (ii) above. The exclusive jurisdiction and venue of any IP Protection Action or, if you timely provide ATGATT with an Arbitration Opt-out Notice, will be the state and federal courts located in the Northern District of California and each of the parties hereto waives any objection to jurisdiction and venue in such courts. Unless you timely provide ATGATT with an Arbitration Opt-out Notice, you acknowledge and agree that you and ATGATT are each waiving the right to a trial by jury or to participate as a plaintiff or class member in any purported class action or representative proceeding. Further, unless both you and ATGATT otherwise agree in writing, the arbitrator may not consolidate more than one person’s claims, and may not otherwise preside over any form of any class or representative proceeding. If this specific paragraph is held unenforceable, then the entirety of this “Dispute Resolution” section will be deemed void. Except as provided in the preceding sentence, this “Dispute Resolution” section will survive any termination of these Terms.
              </p>
              <h3>
              Arbitration Rules
              </h3>
              ...
              <p>
              Unless you and ATGATT otherwise agree, the arbitration will be conducted in San Francisco County, California. If your claim does not exceed $10,000, then the arbitration will be conducted solely on the basis of the documents that you and ATGATT submit to the arbitrator, unless you request a hearing or the arbitrator determines that a hearing is necessary. If your claim exceeds $10,000, your right to a hearing will be determined by the AAA Rules. Subject to the AAA Rules, the arbitrator will have the discretion to direct a reasonable exchange of information by the parties, consistent with the expedited nature of the arbitration.
              </p>
              <h3>
              ...
              <p>
              Your responsibility to pay any AAA filing, administrative and arbitrator fees will be solely as set forth in the AAA Rules. However, if your claim for damages does not exceed $75,000, ATGATT will pay all such fees unless the arbitrator finds that either the substance of your claim or the relief sought in your Demand for Arbitration was frivolous or was brought for an improper purpose (as measured by the standards set forth in Federal Rule of Civil Procedure 11(b)).
              </p>
              <h2>
              Changes
              </h2>
              <p>
              Notwithstanding the provisions of the “Modification” section above, if ATGATT changes this “Dispute Resolution” section after the date you first accepted these Terms (or accepted any subsequent changes to these Terms), you may reject any such change by sending us written notice (including by email to hello@atgatt.co) within 30 days of the date such change became effective, as indicated in the “Last Updated” date above or in the date of ATGATT’s email to you notifying you of such change. By rejecting any change, you are agreeing that you will arbitrate any Dispute between you and ATGATT in accordance with the provisions of this “Dispute Resolution” section as of the date you first accepted these Terms (or accepted any subsequent changes to these Terms).
              </p>
              <h2>
              General Terms
              </h2>
              <p>
              These Terms constitute the entire and exclusive understanding and agreement between ATGATT and you regarding the Services and Content, and these Terms supersede and replace any and all prior oral or written understandings or agreements between ATGATT and you regarding the Services and Content. If any provision of these Terms is held invalid or unenforceable (either by an arbitrator appointed pursuant to the terms of the “Arbitration” section above or by court of competent jurisdiction, but only if you timely opt out of arbitration by sending us an Arbitration Opt-out Notice in accordance with the terms set forth above), that provision will be enforced to the maximum extent permissible and the other provisions of these Terms will remain in full force and effect.
              You may not assign or transfer these Terms, by operation of law or otherwise, without ATGATT’s prior written consent. Any attempt by you to assign or transfer these Terms, without such consent, will be null and of no effect. ATGATT may freely assign or transfer these Terms without restriction. Subject to the foregoing, these Terms will bind and inure to the benefit of the parties, their successors and permitted assigns.
              Any notices or other communications provided by ATGATT under these Terms, including those regarding modifications to these Terms, will be given: (i) by ATGATT via email; or (ii) by posting to the Services. For notices made by e-mail, the date of receipt will be deemed the date on which such notice is transmitted.
              ATGATT’s failure to enforce any right or provision of these Terms will not be considered a waiver of such right or provision. The waiver of any such right or provision will be effective only if in writing and signed by a duly authorized representative of ATGATT. Except as expressly set forth in these Terms, the exercise by either party of any of its remedies under these Terms will be without prejudice to its other remedies under these Terms or otherwise.
              </p>
              <h2>
              Contact Information
              </h2>
              <p>
              If you have any questions about these Terms or the Services, please contact ATGATT at hello@atgatt.co.
              </p>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="card-header" role="tab" id="privacy-policy-card">
        <h5 class="mb-0">
          <a class="collapsed" data-toggle="collapse" href="#collapse-privacy-policy" role="button" aria-expanded="false" aria-controls="collapse-privacy-policy">
            Privacy Policy
          </a>
        </h5>
      </div>
      <div id="collapse-privacy-policy" class="collapse" role="tabpanel" aria-labelledby="privacy-policy-card" data-parent="#accordion">
        <div class="card-body">
            <small>Last updated 1/5/2020</small>
            <hr/>
            <h5>
