    ...
    <div class="card">
      ...
      <div id="collapse-terms-of-service" class="collapse" role="tabpanel" aria-labelledby="terms-of-service-card" data-parent="#accordion">
        <div class="card-body">
              ...
              <p>
              Unless you and CrashTested otherwise agree, the arbitration will be conducted in San Francisco County, California. If your claim does not exceed $10,000, then the arbitration will be conducted solely on the basis of the documents that you and CrashTested submit to the arbitrator, unless you request a hearing or the arbitrator determines that a hearing is necessary. If your claim exceeds $10,000, your right to a hearing will be determined by the AAA Rules. Subject to the AAA Rules, the arbitrator will have the discretion to direct a reasonable exchange of information by the parties, consistent with the expedited nature of the arbitration.
              </p>
              <h3>
