<template>
  <div class="jumbotron">
    ...
    <hr class="my-4">
    <p>CrashTested was built by a small team of Software Engineers working out of San Diego, California. Click <a href="mailto:hello@crashtested.co">here</a> to contact us.
    <br>We source our ratings by aggregating data from widely known organizations such as SHARP, SNELL, ECE, and DOT.</p>
      ...
      <div class="card">
        ...
        <div id="collapse-terms-of-service" class="collapse" role="tabpanel" aria-labelledby="terms-of-service-card" data-parent="#accordion">
          <div class="card-body">
                <h5>
                  Welcome to CrashTested! We (“CrashTested”) provide the website located at https://crashtested.co (the “Site”) and the services accessible via our Site and our mobile device application (“App”). To make these Terms easier to read, the Site, our services and App are collectively called the “Services.” Please read these Terms of Service (the “Terms”) carefully because they govern your use of our Services.
                </h5>
                <br />
                ...
                <p>
                  ...
                  Using the Services
                  CrashTested publishes information on this website as a convenience to its users. It is possible and likely that the product specifications, details, appearance, pricing and performance of products described on CrashTested will differ from the same product offered for sale by the manufacturer, distributor or retailer. This often happens for a variety of reasons and we can take no responsibility for those differences. Make sure you contact the manufacturer or retailer for the latest up-to-date pricing, information, specifications and performance information prior to purchasing any of the products described on CrashTested.

                  The information presented on CrashTested, including product reviews, comments and evaluations, is based on third-party reviews and is provided for informational purposes only. CrashTested has not individually evaluated any claim or statement regarding the products featured on this site.

                  CrashTested attempts to provide accurate and timely information, but there may be inadvertent technical or factual inaccuracies and typographical errors. We reserve the right to make corrections and changes to this website at any time without notice.
                  CrashTested cannot guarantee that the product information, photographs, drawings or images accurately portray the actual products as described.

                  Your experience with the products or information may, and probably will, be completely different from the information or descriptions on this website, due to many factors, including changes that the manufacturer may make in products over time. The website contains links to websites on the Internet which are owned and operated by third parties. You acknowledge that CrashTested is not responsible for the availability of, or the content located on or through, any external website. You should contact the site administrator or webmaster for those external websites if you have any concerns regarding such links or the content located on such external websites. You assume all responsibility and risk with respect to their use of the website and the information contained herein.
                  All information contained on this website is provided to you “AS IS” and CrashTested disclaims all warranties, representations and endorsements, express or implied, with regard to information accessed from or via this website, including but not limited to all express and implied warranties. CrashTested disclaims any duty to update the website or modify the Content or code and shall not be liable for the failure to update the information. CrashTested does not warrant that this website is free of computer viruses or other harmful components and does not warrant that the functionality of this website will be uninterrupted or error-free. CrashTested reserves the right to withdraw access to this website or to revise the Services and products described on the website at any time without notice.
                  ...
                  CrashTested is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com. Amazon and the Amazon logo are trademarks of Amazon.com, Inc. or its affiliates.
                ...
                <p>
                CrashTested does not claim any ownership rights in any User Content and nothing in these Terms will be deemed to restrict any rights that you may have to use and exploit your User Content. Subject to the foregoing, CrashTested and its licensors exclusively own all right, title and interest in and to the Services and Content, including all associated intellectual property rights. You acknowledge that the Services and Content are protected by copyright, trademark, and other laws of the United States and foreign countries. You agree not to remove, alter or obscure any copyright, trademark, service mark or other proprietary rights notices incorporated in or accompanying the Services or Content.
                </p>
                <h2>
                Rights in User Content Granted by You
                </h2>
                <p>
                By making any User Content available through Services you hereby grant to CrashTested a non-exclusive, transferable, sublicenseable, worldwide, royalty-free license to use, copy, modify, create derivative works based upon, distribute, publicly display, publicly perform and distribute your User Content in connection with operating and providing the Services and Content to you and to other users.
                </p>
                <h2>
                Rights in Content Granted by CrashTested
                </h2>
                <p>
                Subject to your compliance with these Terms, CrashTested grants you a limited, non-exclusive, non-transferable, non-sublicenseable license to download, view, copy and display the Content solely in connection with your permitted use of the Services and solely for your personal and non-commercial purposes.
                </p>
                <h2>
                ...
                <br />
                <h3>
                Rights in App Granted by CrashTested
                </h3>
                <p>
                  Subject to your compliance with these Terms, CrashTested grants you a limited non-exclusive, non-transferable, non-sublicenseable license to download and install a copy of the App on a mobile device or computer that you own or control and to run such copy of the App solely for your own personal non-commercial purposes. CrashTested reserves all rights in and to the App not expressly granted to you under these Terms.
                  ...
                  <ul>
                    ...
                    <li>Use, display, mirror or frame the Services, or any individual element within the Services, CrashTested’s name, any CrashTested trademark, logo or other proprietary information, or the layout and design of any page or form contained on a page, without CrashTested’s express written consent;</li>
                    <li>Access, tamper with, or use non-public areas of the Services, CrashTested’s computer systems, or the technical delivery systems of CrashTested’s providers;</li>
                    <li>Attempt to probe, scan, or test the vulnerability of any CrashTested system or network or breach any security or authentication measures;</li>
                    <li>Avoid, bypass, remove, deactivate, impair, descramble or otherwise circumvent any technological measure implemented by CrashTested or any of CrashTested’s providers or any other third party (including another user) to protect the Services;</li>
                    <li>Attempt to access or search the Services or download Collective Content from the Services through the use of any engine, software, tool, agent, device or mechanism (including spiders, robots, crawlers, data mining tools or the like) other than the software and/or search agents provided by CrashTested or other generally available third party web browsers;</li>
                    ...
                    <li>Use any meta tags or other hidden text or metadata utilizing a CrashTested trademark, logo URL or product name without CrashTested’s express written consent;</li>
                ...
                <p>
                You will indemnify and hold harmless CrashTested and its officers, directors, employee and agents, from and against any claims, disputes, demands, liabilities, damages, losses, and costs and expenses, including, without limitation, reasonable legal and accounting fees, arising out of or in any way connected with (i) your access to or use of the Services or Content or (ii) your violation of these Terms.
                </p>
                <h2>
                Limitation of Liability
                </h2>
                <p>
                Neither CrashTested nor any other party involved in creating, producing, or delivering the Services or Content will be liable for any incidental, special, exemplary or consequential damages, including lost profits, loss of data or goodwill, service interruption, computer damage or system failure or the cost of substitute services arising out of or in connection with these terms or from the use of or inability to use the Services or Content, whether based on warranty, contract, tort (including negligence), product liability or any other legal theory, and whether or not CrashTested has been informed of the possibility of such damage, even if a limited remedy set forth herein is found to have failed of its essential purpose. Some jurisdictions do not allow the exclusion or limitation of liability for consequential or incidental damages, so the above limitation may not apply to you.
                In no event will CrashTested’s total liability arising out of or in connection with these terms or from the use of or inability to use the Services or Content exceed the amounts you have paid to CrashTested for use of the Services or Content or fifty dollars ($50), if you have not had any payment obligations to CrashTested, as applicable. The exclusion and limitations of damages set forth above are fundamental elements of the basis of the bargain between CrashTested and you.
                </p>
                <h2>
                Dispute Resolution
                </h2>
                ...
                <p>
                Unless you and CrashTested otherwise agree, the arbitration will be conducted in San Diego County, California. If your claim does not exceed $10,000, then the arbitration will be conducted solely on the basis of the documents that you and CrashTested submit to the arbitrator, unless you request a hearing or the arbitrator determines that a hearing is necessary. If your claim exceeds $10,000, your right to a hearing will be determined by the AAA Rules. Subject to the AAA Rules, the arbitrator will have the discretion to direct a reasonable exchange of information by the parties, consistent with the expedited nature of the arbitration.
                </p>
                <h3>
                ...
                <p>
                Your responsibility to pay any AAA filing, administrative and arbitrator fees will be solely as set forth in the AAA Rules. However, if your claim for damages does not exceed $75,000, CrashTested will pay all such fees unless the arbitrator finds that either the substance of your claim or the relief sought in your Demand for Arbitration was frivolous or was brought for an improper purpose (as measured by the standards set forth in Federal Rule of Civil Procedure 11(b)).
                </p>
                <h2>
                Changes
                </h2>
                ...
                <p>
                These Terms constitute the entire and exclusive understanding and agreement between CrashTested and you regarding the Services and Content, and these Terms supersede and replace any and all prior oral or written understandings or agreements between CrashTested and you regarding the Services and Content. If any provision of these Terms is held invalid or unenforceable (either by an arbitrator appointed pursuant to the terms of the “Arbitration” section above or by court of competent jurisdiction, but only if you timely opt out of arbitration by sending us an Arbitration Opt-out Notice in accordance with the terms set forth above), that provision will be enforced to the maximum extent permissible and the other provisions of these Terms will remain in full force and effect.
                You may not assign or transfer these Terms, by operation of law or otherwise, without CrashTested’s prior written consent. Any attempt by you to assign or transfer these Terms, without such consent, will be null and of no effect. CrashTested may freely assign or transfer these Terms without restriction. Subject to the foregoing, these Terms will bind and inure to the benefit of the parties, their successors and permitted assigns.
                Any notices or other communications provided by CrashTested under these Terms, including those regarding modifications to these Terms, will be given: (i) by CrashTested via email; or (ii) by posting to the Services. For notices made by e-mail, the date of receipt will be deemed the date on which such notice is transmitted.
                CrashTested’s failure to enforce any right or provision of these Terms will not be considered a waiver of such right or provision. The waiver of any such right or provision will be effective only if in writing and signed by a duly authorized representative of CrashTested. Except as expressly set forth in these Terms, the exercise by either party of any of its remedies under these Terms will be without prejudice to its other remedies under these Terms or otherwise.
                </p>
                <h2>
                Contact Information
                </h2>
      ...
      <div class="card">
        ...
        <div id="collapse-privacy-policy" class="collapse" role="tabpanel" aria-labelledby="privacy-policy-card" data-parent="#accordion">
          <div class="card-body">
              <small>Last updated 2/23/2018</small>
              <hr/>
              <h5>
